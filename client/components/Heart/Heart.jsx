    ...
    return (
      <div className={Style.favoritebutton} onMouseOver={overHeart} onMouseLeave={exitHeart}>
        <button className={Style.heart} onClick={toggleFavorite}>
          {favorited ? 
            // Red Heart SVG
            <svg className={Style.favorited} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
            ...
            // White Heart SVG (thanks Etsy elements inspector)
